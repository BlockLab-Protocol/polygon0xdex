...
const FEE_RECIPIENT = "0x02462393ba75bc6894cC1863C46fa5dfEC4B5a02"; // The ETH address that should receive affiliate fees
const feeRecipientTradeSurplus = "0x02462393ba75bc6894cC1863C46fa5dfEC4B5a02";
...
export default function PriceView({
  ...
  const { isLoading: isLoadingPrice } = useSWR(
    [
      "/api/price",
      {
        ...
        feeRecipientTradeSurplus: feeRecipientTradeSurplus,
      },
    ],
    fetcher,
    {
  ...
  return (
   <form>
      <h1 className="text-blue-500 text-3xl font-bold mb-4">BLOCKLAB-PROTOCOL</h1>
      <p className="text-blue-200 text-md mb-2">
       BLOCKSWAP YOUR BEST DEX AGRREGATOR <a href="https://0x.org/docs/">Powered by 0x</a> <a href="https://0x.org/docs/"><br/>Low-Fees,</a> Safe, No Slippage!, No Front-running!{" "}
        
      </p>
      <p className="text-blue-50 text-md font-bold mb-2">Swap on any Network at best rates ..</p>
      ...
      {isLoadingPrice && (
        <div className="text-center mt-2" style={{ color: "yellow" }}>Fetching the best price...</div>
      )}
  </form>
  );
}
...
//  const fomattedExchangeProxy: string[] = exchangeProxy.map(address => `0x${address}`);
